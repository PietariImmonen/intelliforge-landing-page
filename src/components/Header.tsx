  ...
  return (
    <header className="flex items-center justify-between px-8 py-4">
      ...
      <nav className="hidden md:flex items-center gap-8">
        <a href="#features" className="hover:text-[#FFE612] transition-colors">Features</a>
        <a href="#benefits" className="hover:text-[#FFE612] transition-colors">Benefits</a>
        <a href="#testimonials" className="hover:text-[#FFE612] transition-colors">Success Stories</a>
        <a 
